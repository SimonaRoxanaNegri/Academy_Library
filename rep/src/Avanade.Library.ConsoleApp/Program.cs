...
namespace Avanade.Library.ConsoleApp
{
    public static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string authResult = controller.RequestLogin(username, password);
                ...
                switch (authResult)
                {
                    ...
                    case "Admin":
                        ...
                        switch (Console.ReadLine())
                        {
                            ...
                            case "2":
                                ...
                                Console.Write(controller.RequestReservation(BookId) + "\n");
                                break;
                            ...
                            case "5":
                                ...
                                string resultBook = controller.RequestAddBook(title, authorName, authorSurName, publishingHouse, quantity);
                            ...
                            case "6":
                                ...
                                if (BookId <= 0)
                                {
                                    ...
                                    break;
                                        ...
                                        {
                                            resultBookUpdate = controller.RequestUpdateBook(BookId, title, authorName, authorSurName, publishingHouse);
                            ...
                            case "7":
                                ...
                                string resultBookDelete = controller.RequestDeleteBook(BookId);
                    ...
                    default:
                        ...
                        else
                        {
                            ...
                            view.AskPassword();
                            password = Console.ReadLine();
                            authResult = controller.RequestLogin(username, password);
                        }
                        break;
