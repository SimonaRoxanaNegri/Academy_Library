...
namespace Avanade.Library.DAL
{
    public class DbDal : IDal
    {
        ...
        public int GetQuantityBooksById(int BookId)
        {
            IBook book = new Book();
                        ...
                        if (sqlDataReader.HasRows)
                        {
                            using (DataSet ds = new DataSet())
                            {
                                while (sqlDataReader.Read())
                                {
                                    ...
                                    bookStatus.DateAvailable = sqlDataReader.GetDateTime(5);
                        ...
                        if (sqlDataReader.HasRows)
                        {
                            using (DataSet ds = new DataSet())
                            {
                                while (sqlDataReader.Read())
                                {
                                    ...
                                    historyReservationsStatus.BookId = sqlDataReader.GetInt32(0);
                                    historyReservationsStatus.Title = sqlDataReader.GetString(1);
                                    historyReservationsStatus.Username = sqlDataReader.GetString(2);
                                    historyReservationsStatus.StartDate = sqlDataReader.GetDateTime(3);
                                    historyReservationsStatus.EndDate = sqlDataReader.GetDateTime(4);
                                    historyReservationsStatus.ReservationId = sqlDataReader.GetInt32(5);
                                    historyReservationsStatus.Reserved = sqlDataReader.GetInt32(6) == 1;
